...
| REQ-AUTH-02 | 잠긴 계정 로그인 차단 | 기능 | TC-UI-002 | ✅ | Pass |
| REQ-AUTH-03 | 필수 입력값 검증 | 기능 | TC-UI-003 | ✅ | Pass |
| REQ-CART-01 | 장바구니 담기 수량 반영 | 기능 | TC-UI-004 | ✅ | Pass |
...
| REQ-ROUTE-03 | 경로 검색 빈 결과 처리 | 기능(사용성) | TC-MOCK-006 | ✅ | Pass |
...
| REQ-COMPAT-01 | 데스크톱/모바일 뷰포트 호환 | 비기능(호환성) | TC-UI-001~004 | ✅ | Pass |
...
| TC-UI-004 | REQ-CART-01, REQ-COMPAT-01 | Playwright |
...
| --- | --- | --- |
| 기능적합성 | REQ-AUTH-01/03, REQ-CART-01, REQ-API-01/03/04, REQ-ROUTE-01, REQ-FAV-01/02, REQ-PLACE-01 | ✅ |
| 보안 | REQ-AUTH-02 | ✅ |
